...
class  UserManager(BaseUserManager):
    def create_user(self, first_name, last_name, username, email, password=None):
        ...
        user = self.model(
            email = self.normalize_email(email), #cambia las mayusculas a minusculas en el caso que hayan,
            username = username,
...
class User(AbstractBaseUser):
    ...
    #se aumenta esta funcion para que no exista error al abrir el administrador
